...
/* Add additional port pin initializations here */
  ATDDIEN = 0xFF;  // PAD7 and PAD6 pins digital inputs
  prevpb = 1; // pushbutton
  PTT_PTT0 = 0; 
  PTT_PTT1 = 0; 
  DDRAD = 0;
...
void tdisp()
{
  chgline(0x80);                       // clear
  pmsglcd("Time = ");
  print_c(react / 100 + 48);           // print ASCII
  print_c((react % 100) / 10 + 48);
  print_c((react % 100) % 10 + 48);
  outchar(react/100 + 48);
  pmsglcd("ms     ");
