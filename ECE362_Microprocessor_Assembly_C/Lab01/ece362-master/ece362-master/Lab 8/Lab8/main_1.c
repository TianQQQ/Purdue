...
//         speed of the reaction.  This routine should use the "react"
//         variable to determine which number and which message to display
//         ("pmsglcd" will be useful for doing this).
...
//***********************************************************************
// Character I/O Library Routines for 9S12C32 (for debugging)
//***********************************************************************
// Name:         inchar
