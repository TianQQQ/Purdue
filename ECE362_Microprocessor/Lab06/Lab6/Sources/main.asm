...
;
;
; Signature: ________Tian Qiu_____________________________   Date: __10/08/2015__________
;
;       
;***********************************************************************
;
...
irq_isr      	bset	PTM,$08	; send active high clear pulse to external device flag
	            bclr	PTM,$08	;              
